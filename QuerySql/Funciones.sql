...
create or replace function f_insertar_matricula() returns void
as 
$$
declare
	codigo character varying := 'mat' + cast(i_fk_estudiante as character varying);
	fecha date := current_date;
begin 
	insert into t_matricula (vc_codigo, vc_fecha) values (codigo, fecha);
end;
$$
language sql
--------------------------------------------------------------
select f_insertar_matricula()
